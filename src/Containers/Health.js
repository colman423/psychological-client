    ...
    return (
        <div>
            ...
            <div className="text-white p-3 px-md-4">
                ...
                <p><BigSpace></BigSpace>
                    {staff ? "本網站提供員工線上填寫問卷，可藉由本問卷深入了解自身擁有各項資源及身心健康之狀況，另外可獲得台灣產業常模，亦即員工可了解自身狀態在台灣同產業之職業工作者中的相對分數。" : "本網站提供企業可線上填寫之方案檢核表，此檢核表整合了台灣目前多項EAP，可透過此檢核表檢視自身企業有哪些可再增加或是改善的方案。"}
                </p>
            </div>
        </div>
    );
